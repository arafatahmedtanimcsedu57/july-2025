...
export const projectStats = {
	...
	blocks: [
		{ number: '322', label: 'Videos Analyzed', color: 'text-primary' },
		{ number: '462', label: 'Images Analyzed' },
		{ number: '244', label: 'Documents Analyzed' },
		{ number: '2', label: 'Investigative Films' },
		{
			number: '~0',
			label: 'Interviews with witnesses',
...
export const archiveData = {
	...
	rightSection: {
		heading: 'We Also Collect:',
		items: [
			'records of daily events, registering potential war crimes',
			'public media materials, including social media sources',
			'materials from open sources and partner organizations',
			'testimonies of witnesses and victims of the uprising',
			'evidence of human propaganda and the development of pro-government narratives',
		],
	},
};
