							...
							<AccordionContent className="space-y-6 text-slate-600">
								...
								<section className="space-y-6">
									...
									<div className=" flex flex-col">
										{Object.entries(investigation.method).map(
											([key, value]) => (
												<div key={key}>
							...
							<AccordionContent className="space-y-6 text-slate-600">
								...
								<section className="space-y-6">
									...
									<ul className="list-disc list-inside space-y-1">
										<li>
											<strong>Frame-by-Frame Analysis:</strong>{' '}
											{film.types_of_analysis_conduct.frame_by_frame_analysis}
										</li>
										<li>
											<strong>Geolocation Verification:</strong>{' '}
											{film.types_of_analysis_conduct.geolocation_verification}
										</li>
										<li>
											<strong>Audio Analysis:</strong>{' '}
											{film.types_of_analysis_conduct.audio_analysis}
										</li>
										<li>
											<strong>Slow Motion Review:</strong>{' '}
											{film.types_of_analysis_conduct.slow_motion_review}
										</li>
										<li>
											<strong>Law Enforcement Unit Identification:</strong>{' '}
											{
												film.types_of_analysis_conduct
													.law_enforcement_unit_identification
											}
										</li>
									</ul>
								</section>
								...
								<section className="space-y-6">
									...
									<ul className="list-disc list-inside ">
										{film.open_source_research.map((source, idx) => (
											<li key={`${source.label}-${idx}`}>
												<strong>{source.label}:</strong> {source.para}{' '}
												{source.link && (
													<a
														key={source.link}
								...
								<section className="space-y-6">
									...
									{film.timeline_of_the_incident.analysis.map((eventGroup) => (
										<div
											key={eventGroup.map((e) => e.label).join('-')}
											className="border-l-2 border-gray-300 pl-4 ml-2 space-y-4"
										>
