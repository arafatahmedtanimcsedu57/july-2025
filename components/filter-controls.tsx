                            ...
                            return (
                              ...
                              >
                                ...
                                <div className="flex gap-2 items-center justify-center">
                                  {day.hasDeath ? (
                                    <div
                                      className={`rounded-full min-h-[4px] min-w-[4px]`}
                                      style={{
                                        background: `${MARKER_COLORS.Death.color}`,
                                      }}
                                    ></div>
                                  ) : (
                                    <></>
                                  ...
                                  {day.hasInjury ? (
                                    <div
                                      className={`rounded-full min-h-[4px] min-w-[4px]`}
                                      style={{
                                        background: `${MARKER_COLORS.Injury.color}`,
                                      }}
                                    ></div>
                                  ) : (
                                    <></>
                                  ...
                                  {day.hasDeath ? (
                                    <div
                                      className={`rounded-full min-h-[4px] min-w-[4px]`}
                                      style={{
                                        background: `${MARKER_COLORS["Multiple Casualties"].color}`,
                                      }}
                                    ></div>
                                  ) : (
                                    <></>
